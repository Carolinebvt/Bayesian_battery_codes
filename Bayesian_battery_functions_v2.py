...
pos_bar=(0,-100) # position of the bar for confidence rating
...
def rate_confidence(exp, pos = pos_bar, slider_var = 30, bar_length = 300, 
                    bar_thick = 5):
...
def create_note(frequency):
    ...
    """
    sample_rate = 44100  # 44100 samples per second
    seconds = 0.6  # Note duration of 1 second
